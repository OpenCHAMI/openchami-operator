...
// +kubebuilder:rbac:groups=postgresql.cnpg.io,resources=clusters;databases,verbs=get;list;watch;create;update;patch;delete
...
// endpointslices for default/kubernetes are read to discover the concrete
